							...
							<div class="row">
								...
								<div class="col-sm-12">
									<div class="form-group">
										...
										<input type="text" class="form-control" id="name" name="name" placeholder="eg. Action / Adventure" data-validetta="required,minLength[1]">
									</div>
								</div>
								...
								<div class="col-sm-12" style="display: none;">
									<div class="form-group">
										...
										<select name="parent_id" class="selectpicker form-control">
											...
											<?php $content->getCatDropList(0, 0,"&#166;&nbsp;&nbsp;&nbsp;&nbsp;");?>
										</select>
									</div>
								</div>
								...
								<div class="col-sm-12">
									<div class="form-group">
										...
										<input type="text" class="form-control" id="slug" name="slug" placeholder="eg. action-adventure" data-validetta="required,minLength[1]">
									</div>
								</div>
								...
								<div class="col-sm-12">
									...
									<textarea class="form-control" rows="8" id="description" name="description" placeholder="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque urna dui, finibus sed diam quis, ultrices commodo mauris."></textarea>
								</div>
							...
							<div class="row">
								<div class="col-md-12 top10">
									...
									<div class="radio radio-primary radio-inline">
								        <input type="radio" id="published_1" name="active" value="1" checked/>
								...
								<div class="col-md-12 top40">
									<button type="button" name="dosubmit" class="btn btn-default">Add Category</button>
								...
								<div class="col-sm-12">
									<div class="form-group">
										<div id="external-events">
											<div id="menusort"> <?php echo $content->getSortCatList();?></div>
										</div>
									</div>
								</div>
