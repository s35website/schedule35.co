...
<div class="content">
	...
	<div class="page-header">
		...
		<ol class="breadcrumb">
			...
			<li><a href="index.php?do=categories">Categories</a></li>
		...
		<div class="right">
			<div class="btn-group" role="group" aria-label="...">
				<a href="index.php?do=categories" class="btn btn-light"><i class="fa fa-chevron-left"></i>Add category</a>
			</div>
		</div>
	...
	<div class="container-widget bot10">
		...
		<div class="row">
			...
			<div class="col-sm-6">
				...
				<a class="btn btn-default" href="index.php?do=categories">Add Category</a>
			</div>
								...
								<div class="col-sm-12" style="display: none;">
									<div class="form-group">
										...
										<select name="parent_id" class="selectpicker form-control">
											...
											<?php $content->getCatDropList(0, 0,"&#166;&nbsp;&nbsp;&nbsp;&nbsp;", $row->parent_id);?>
										</select>
									</div>
								</div>
