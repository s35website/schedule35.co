...
/* Chart Line btn primary */
$(".sparkline-btn primary").sparkline([4,2,1,6,2,3,5,2,3,1,3], {
    type: 'line',
    width: '105',
    height: '30',
    lineColor: '#26a65b',
...
$(".sparkline-lightblue").sparkline([4,2,2,4,2,6,5,2,3,1,3], {
    type: 'line',
    width: '105',
    height: '30',
    lineColor: '#C1E0FF',
...
$(".sparkline-blue").sparkline([4,2,2,4,2,6,5,2,3,1,3], {
    ...
    highlightLineColor: '#666666',
    drawNormalOnTop: false});
/* Chart Line Dark Blue */
$(".sparkline-darkblue").sparkline([4,2,2,4,2,6,5,2,3,1,3], {
    type: 'line',
    width: '105',
    height: '30',
    lineColor: '#34577A',
