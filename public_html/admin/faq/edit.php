...
<div class="content">
	...
	<div class="row presentation">
		...
		<div class="col-lg-8 col-md-12 titles">
			<h1>Edit FAQ</h1>
			<h4>Here you can Edit a new question. <br />Fields marked with a <i class="fa fa-asterisk"></i> are required.</h4>
		</div>
						...
						<form id="faq_add" name="faq_add" method="post">
							...
							<div class="row">
								...
								<div class="col-md-12">
									<div class="form-group">
										...
										<textarea class="form-control" rows="2" id="question" name="question" data-validetta="required,minLength[1]"><?php echo $row->question;?></textarea>
									</div>
								</div>
								...
								<div class="col-md-12">
									<div class="form-group">
										...
										<textarea class="form-control" rows="8" id="answer" name="answer" data-validetta="required,minLength[1]"><?php echo $row->answer;?></textarea>
									</div>
								</div>
							...
							<div class="row">
								...
								<div class="col-md-12 top40">
									<button type="button" name="dosubmit" class="btn btn-default" disabled="true">Save Question</button>
