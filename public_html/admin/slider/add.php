						...
						<form id="slider_add" name="slider_add" method="post">
							...
							<div class="row">
								<div class="col-sm-12 col-md-6">
									<div class="form-group">
										...
										<input type="text" class="form-control" autocomplete="off" id="caption" name="caption" placeholder="eg. Featured Product: The Zambalaya"  data-validetta="required">
									</div>
								</div>
							...
							<div class="row">
								...
								<div class="col-sm-12 col-md-6">
									<div class="form-group urltype">
										...
										<div class="radio radio-primary radio-inline">
											<input id="urltype_ext" name="urltype" type="radio" value="ext" data-link="url_external">
											<label for="urltype_ext"> External Link </label>
										</div>
										<div class="radio radio-primary radio-inline">
											<input id="urltype_int" name="urltype" type="radio" value="int" data-link="url_internal">
											<label for="urltype_int"> Internal Link </label>
										</div>
										<div class="radio radio-primary radio-inline">
											<input id="urltype_nourl" name="urltype" type="radio" value="nourl" checked="checked">
								...
								<div class="col-sm-12 col-md-5">
									...
									<div class="form-group slider_link" id="url_external" style="display: none;">
										<label for="url" class="form-label">External Link</label>
										<input type="text" class="form-control" autocomplete="off" id="url" name="url" placeholder="eg. http://www.google.com">
									</div>
									
									<div class="form-group slider_link" id="url_internal" style="display: none;">
										<label for="type" class="form-label">Internal Page</label>
										<?php echo Content::getProductList("id");?>
									</div>
							...
							<div class="row">
								...
								<div class="col-md-12 top40">
									<button type="button" name="dosubmit" class="btn btn-default" disabled="true">Add Slide</button>
