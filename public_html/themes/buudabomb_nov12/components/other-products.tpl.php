...
<?php if($otherrow && count($otherrow) >= 1):?>
	...
	<h4 class="t60 p12"><a href="<?php echo SITEURL;?>/shop">More things to munch on...</a></h4>
		...
		<div class="col-sm-4">
			<a class="product p12" href="<?php echo $url;?>">
				<div class="item-image">
					<img src="<?php echo UPLOADURL;?>prod_images/<?php echo ($orow->thumb) ? $orow->thumb : "blank.png";?>" alt="<?php echo $orow->title;?>" />
				</div>
