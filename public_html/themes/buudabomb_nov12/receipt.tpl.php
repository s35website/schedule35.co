					...
					<div class="card-overview">
						...
						<div class="overview-body">
							<div class="purchase-overview">
								...
								<?php if($receiptInvoice->pp == 'BuudaPoints'):?>
								<p class="border-bottom p0" style="padding-bottom: 12px;">
									Thank you for using <strong>BuudaPoints</strong>. We hope your experience has been legendary.
								</p>
								<?php elseif($receiptInvoice->pp != 'eTransfer'):?>
								<p>
									Please note that all orders made on this website will appear as <strong>BUUDABMB x SANGO</strong> on your credit card.
								</p>
						...
						<footer class="overview-footer">
							<span class="site inline-block">
								<img style="display: block; float: left; width: 30px;opacity: 0.6;" src="<?php echo THEMEURL;?>/assets/img/icons/payment-buudapay.png">
							</span>
						</footer>
						<?php elseif($receiptInvoice->pp != 'eTransfer'):?>
						<footer class="overview-footer">
