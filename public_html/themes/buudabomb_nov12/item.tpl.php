...
<body class="fixed-header header-active <?php echo (($notification == 1) ? 'has-notification' : ''); ?>">
	...
	<div id="item" class="main" data-id="<?php echo($row->id); ?>">
				...
				<div class="row product-page">
					...
					<div class="col-md-6 product-photo">
						...
						<div class="large-image">
							<div class="placeholder" data-large="<?php echo UPLOADURL;?>prod_images/<?php echo ($row->thumb);?>">
						...
						<div class="product-page-gallery">
							<ul>
								<li class="thumbnail active">
									<img alt="<?php echo $row->title;?>" data-src="<?php echo UPLOADURL;?>prod_images/<?php echo ($row->thumb);?>" src="<?php echo UPLOADURL;?>prod_images/<?php echo ($row->thumb) ? $row->thumb : "blank.png";?>" />
								</li>
					...
					<div class="col-md-5 product-details">
						...
						<div id="productsect">
							...
							<div class="add-to-cart-wrap">
								...
								<div id="content-points" class="content-popover" style="display: none;">
									<h5>Earning like a Boss</h5>
									<p>Earn points and use them to make purchases, unlock special badges, or gain access to special promotions.</p>
								</div>
						...
						<div class="product-attributes">
							...
							<div class="row" style="font-size: 1px; text-align: center;">
								<div class="col-4 col-item-icon tooltip" title="Each bag is filled with <?php echo $row->dosage;?>mg of THC.">
									<span class="icon ico-thc"></span>
									<h6><?php echo $row->dosage;?>mg of THC <br/>/ bag</h6>
								</div>
								<div class="col-4 col-item-icon tooltip" title="Each bag contains <?php echo $row->pieces;?> pieces.">
									<span class="icon ico-gummy ico-cat<?php echo $row->cid;?>"></span>
		...
		<section class="wrapper more-products products">
