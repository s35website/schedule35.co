...
<body class="<?php echo (($notification == 1) ? 'has-notification' : ''); ?>">
					...
					<section class="faq-questions" id="faq-top">
						...
						<div class="form-validetta masta section" id="whenwillmypackagearrive_faq">
							...
							<div class="form view grid">
								...
								<p>
									<strong>Canada Post is responding to an unprecedented amount of parcel shipments due to the COVID-19 pandemic and you may experience some delays with your package</strong>. Please use the provided tracking information for the most up to date information on your package. 
								</p>
								<p>
					...
					<section class="faq-questions" id="faq-order">
						...
						<div class="form-validetta masta section">
							...
							<div class="form view grid">
								...
								<p>All orders are securely and discretely packed with no way of seeing what is inside and shipped via Canada Post.</p>
						...
						<div class="form-validetta masta section">
							...
							<div class="form view grid">
								...
								<p>We contribute to your shipping costs on all orders, regardless of the transportation mode or location. For orders outside of Ontario, the costs are significantly higher, leaving a remainder of $<?php echo $core->shipping_standard;?> or more after our contribution is applied.</p>
	...
	<script type="text/javascript">
		...
		// Add hash
		if (window.location.hash == "#whenwillmypackagearrive") {
			$("#whenwillmypackagearrive_faq").addClass("show");
			$("#whenwillmypackagearrive_faq .form").show();
		}
	</script>
