							...
							<div id="form-invite" class="container-overlay">
								...
								<div class="login-padding">
									...
									<div class="login-switch small">
										Need an Invite? <a href="<?php echo SITEURL;?>/invitations">Click here.</a>
									</div>
							...
							<div id="form-registration" class="<?php echo (($core->invite_only == 1) ? 'invisible' : ''); ?>">
								...
								<div class="login-padding">
									...
									<div class="form-group">
										<div class="row">
											<div class="col-12">
												<input type="checkbox" id="age_very" name="age_very" value="age" data-validetta="required"><label for="age_very"><span>I am over 19 years of age</span></label>
											</div>
										</div>
									</div>
