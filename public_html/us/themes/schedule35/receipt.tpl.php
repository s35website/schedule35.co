					...
					<div class="card-overview">
						...
						<div class="overview-body">
							<div class="purchase-overview">
								...
								<p>
									Please note that all orders made on this website will appear as <strong>[Living Normally / LVGNM]</strong> on your credit card.
								</p>
							...
							<div class="descriptor">
								<p>
									...
									<span class="descriptor-track">Tracking #: <a target="_blank" href="https://tools.usps.com/go/TrackConfirmAction?qtc_tLabels1=<?php echo $receiptInvoice->trackingnum;?>"><?php echo $receiptInvoice->trackingnum;?></a></span>
								</p>
