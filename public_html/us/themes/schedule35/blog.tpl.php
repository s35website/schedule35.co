...
<body id="page-blog" class="<?php echo (($notification == 1) ? 'has-notification' : ''); ?>">
			...
			<section class="wrapper padded text-center container max-width">
				...
				<div class="t60">
					...
					<div class="row">
						...
						$counter = 1;
						foreach($blogrow as $brow):?>
						
					    <?php $url = ($core->seo) ? SITEURL . '/article/' . $brow->slug . '/' : SITEURL . '/article?blog=' . $brow->slug;?>
						
						<?php if($counter == 1):?>
						<div class="col-sm-12 blog" data-id="<?php echo $brow->id;?>">
						<?php else:?>
						<!--<div class="col-sm-12 col-md-6 blog" data-id="<?php echo $brow->id;?>">-->
						<div class="col-sm-12 col-md-12 blog" data-id="<?php echo $brow->id;?>">
						<?php endif;?>
							...
							<div class="blog-info">
								<h3 class="p6 t12"><a href="<?php echo $url;?>"><?php echo $brow->title;?></a></h3>
								<div class="blog-meta">
									<a class="author"><?php echo $brow->author;?></a>
