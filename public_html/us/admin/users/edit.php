							...
							<div class="row">
								...
								<div class="col-sm-6">
									<div class="form-group">
										...
										<input type="number" class="form-control" id="points_current" name="points_current" placeholder="John" data-validetta="required,minLength[1]" value="<?php echo $row->points_current;?>">
									</div>
								</div>
								...
								<div class="col-sm-6">
									<div class="form-group">
										...
										<input type="number" class="form-control" id="points_lifetime" name="points_lifetime" placeholder="Doe" value="<?php echo $row->points_lifetime;?>">
									</div>
								</div>
								...
								<div class="col-sm-4">
									<div class="form-group">
										...
										<input type="number" autocomplete="off" class="form-control" id="invites" name="invites" data-validetta="minLength[1]" value="<?php echo $row->invites;?>">
									</div>
								</div>
								...
								<div class="col-sm-4">
									<div class="form-group">
										...
										<input type="text" autocomplete="off" class="form-control" id="invite_code" name="invite_code" data-validetta="minLength[1]" value="<?php echo $row->invite_code;?>">
									</div>
								</div>
								...
								<div class="col-sm-4">
									<div class="form-group">
										...
										<input type="number" autocomplete="off" class="form-control" id="payout" name="payout" data-validetta="minLength[1]" value="<?php echo $row->payout;?>">
									</div>
								</div>
