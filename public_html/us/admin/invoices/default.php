		...
		<div class="right" style="display: block!important;">
			...
			<div class="btn-group">
        		...
        		<ul class="dropdown-menu pull-right" role="menu">
        			...
        			<!-- <li><a id="btnExport" href="#"><i class="fa fa-file-excel-o"></i> Export to Excel</a></li> -->
        		</ul>
			</div>
					...
					<div class="panel-body table-responsive">
						...
						<table id="tproduct" class="table display">
							...
							<tbody>
								...
								<tr tx=<?php echo $row->invid;?> txID=<?php echo $row->id;?> status=<?php echo $row->status;?>>
									<td>
